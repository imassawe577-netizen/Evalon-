...
class HealthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"OK - MASTER SIGNALS PRO Running")
...
# PAYMENT TEXT
# ============================================================
PAYMENT_TEXT = """💰 *UNLOCK MASTER SIGNALS PRO*
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "⚡ *MASTER SIGNALS PRO*\n\n"
        "🎁 *Try our bot FREE before you buy!*\n\n"
        "✅ Get 1 free signal — no payment needed\n"
        "📊 100+ Trading Pairs\n"
        "🏆 Win Rate: 90% — 98%\n\n"
        "👇 Select a trading pair and test it now:",
        ...
        if not is_licensed(user_id) and free_signals_used(user_id)>=1:
            ...
            await context.bot.send_message(
                ...
                text="🔒 *UNLOCK FULL ACCESS*\n\n"
                     ...
                     "✅ Free updates forever\n"
                     "✅ 100+ trading pairs\n\n"
                     "👇 See payment methods or enter your code:",
                parse_mode="Markdown",
                reply_markup=unlock_keyboard()
            )
            return
